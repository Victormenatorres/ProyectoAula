...
// Asignar al producto
     ...
     */
Ctrl_Categoria controladorCategoria = new Ctrl_Categoria(); // Instancia global

private void CargarComboCategorias() {
    jComboBox_categoria.removeAllItems();
    jComboBox_categoria.addItem("Seleccione categoria:");

    for (Categoria cat : controladorCategoria.obtenerCategorias()) {
        jComboBox_categoria.addItem(cat.getDescripcion());
    }
}

private int IdCategoria() {
    String descripcionSeleccionada = (String) jComboBox_categoria.getSelectedItem();
    return controladorCategoria.obtenerIdPorDescripcion(descripcionSeleccionada);
}
private void CargarTablaProductos() {
    ...
    for (Producto producto : ctrlProducto.obtenerProductosActivos()) {
        // Obtener nombre de categoría
        String nombreCategoria = "Sin categoría";
        for (Categoria cat : ctrlCategoria.obtenerCategorias()) {
            if (cat.getIdCategoria() == producto.getIdCategoria()) {
                nombreCategoria = cat.getDescripcion();
                break;
            }
        }

        // Calcular IVA
        double iva = calcularIva(producto.getPrecio(), producto.getPorcentajeIva());
